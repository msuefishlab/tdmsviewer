...
```{r}
install_github('msuefishlab/tdmsviewer@0.4.0')
```

But you might benefit from using the latest version

### Windows 7/8 specific installation errors

The install\_github function doesn’t work fully properly on Windows 7/8
(works fine on Windows 10)

On Windows 7/8, in my experience, the install\_github function it fails
to install some dependencies, so you may have to install them manually.

Possible dependencies you have to manually install includes

install.packages(c('htmlwidgets','DT','RSQLite','Rcpp'))

Note that this is only a problem on windows, other platforms will
install all dependencies automatically when you use
install\_github('msuefishlab/tdmsviewer')
...
By default the basedir is your home directory on Unix or My Documents
folder on Windows
...
![screenshot-127.0.0.1-4748-2017-03-29-15-51-50.png](./media/image1.png)

Figure 1. "Choose TDMS file" button

![screenshot-127.0.0.1-4748-2017-03-29-15-53-30.png](./media/image2.png)

Figure 2. The "Choose TDMS file" file selector

![screenshot-127.0.0.1-4748-2017-03-29-15-54-21.png](./media/image3.png)
...
![screenshot-127.0.0.1-4748-2017-03-29-16-01-49.png](./media/image4.png)
...
![screenshot-127.0.0.1-4748-2017-03-29-16-03-14.png](./media/image5.png)
...
![screenshot-127.0.0.1-4748-2017-03-29-16-05-32.png](./media/image6.png)
...
To identify landmarks, you can interactively click on points of the plot
in the "Saved EODs" tab, and a dialog box will appear asking you if you
want to save this time point as a landmark.

![screenshot-127.0.0.1-4748-2017-03-29-16-11-20.png](./media/image7.png)

Figure 7. Dialog box appears when clicking on a point of the Saved EODs
plot. Here we identify the largest peak as P1, and give it a name
...
Figure 8. Overview of the "Landmark" plots the voltage value for multiple
